...
{{--                        <!-- Message Start -->--}}
{{--                        <div class="media">--}}
{{--                            <img src="/admin/ist/img/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">--}}
{{--                            <div class="media-body">--}}
{{--                                <h3 class="dropdown-item-title">--}}
{{--                                    John Pierce--}}
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('genres_group.create') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('musician.create') }}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Музыкант</p>
                                </a>
                            </li>
...
{{--        <strong>Copyright &copy; 2023 <a href="#">MusLaces</a>.</strong>--}}
{{--        All rights reserved.--}}
...
<!-- File Storage (elFinder + tinyMCE) -->
<script src="https://cdn.tiny.cloud/1/d3i292nh47odqbieuq5j77db2lf2hk13bxfng89f2zx5itca/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
<script>
    tinymce.init({
        selector: '.editor',
