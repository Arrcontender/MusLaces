                ...
                <form action="{{ route('place.update', $place->id) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputBorder">Наименование площадки</label>
                            <input name="name" type="text" value="{{ $place->name }}" class="form-control form-control-border" id="exampleInputBorder" placeholder="Введите">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputBorderWidth2">Описание</label>
                            <input name="description" type="text" value="{{ $place->description }}" class="form-control form-control-border border-width-2" id="exampleInputBorderWidth2" placeholder="Введите">
                        </div>
                        <div class="form-group">
                            <label for="exampleSelectBorder">Жанры</label>
                        ...
                        <div class="form-group">
                            <label for="exampleSelectBorder">Средний чек</label>
