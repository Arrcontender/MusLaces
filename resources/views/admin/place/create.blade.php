...
@section('title', 'Создание площадки')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Создание площадки</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if(session('success'))
                ...
                <form action="{{ route('place.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="average_check" type="text" class="form-control form-control-border border-width-2" id="exampleInputBorderWidth2" placeholder="Введите">
                        </div>
                        <div class="form-group">
